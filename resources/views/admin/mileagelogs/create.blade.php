...
@section('content')
    <div class="container py-4">
        ...
        <h1 class="mb-4">Aggiungi nuovo registro chilometri</h1>
        <div class="card my-0">
            <div class="card-body">
                <form id="mileage-log-form" method="POST" action="{{ route('admin.mileagelogs.store') }}"
                    ...
                    <section class="mb-3 row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('log_date') is-invalid @enderror" id="log_date"
                                name="log_date" value="{{ old('log_date') }}" required>
                            @error('log_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
