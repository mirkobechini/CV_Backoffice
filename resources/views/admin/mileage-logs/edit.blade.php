...
@section('breadcrumb')
    <x-admin.breadcrumb :items="[
        ...
        ['label' => $mileageLog->vehicle->internal_code ?? 'N/A', 'url' => route('admin.mileage-logs.show', $mileageLog->id)],
        ['label' => __('Modifica')],
    ]" />
@endsection
...
@section('content')
    ...
    <div class="page-header">
        <h1>{{ __('Modifica registro chilometri') }}</h1>
    ...
    <div class="form-card">
        <form id="mileage-log-form" method="POST" action="{{ route('admin.mileage-logs.update', $mileageLog->id) }}"
            ...
            <div class="form-section" style="margin-bottom:0;">
                ...
                <div class="row2">
                    <x-form.date-input name="log_date" label="{{ __('Data della registrazione') }}" :model="$mileageLog"
                        required />
                    <div class="field">
                        ...
                        <input type="number" class="input @error('mileage') is-invalid @enderror" id="mileage"
                            name="mileage" value="{{ old('mileage', $mileageLog->mileage) }}" min="0" required>
                        @error('mileage')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="form-actions">
                <button id="mileage-log-edit-submit-btn" type="submit" class="btn primary lg"
