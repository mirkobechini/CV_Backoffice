...
@section('content')
    ...
    <div class="page-header">
        <h1>{{ __('Aggiungi nuovo tipo di veicolo') }}</h1>
    ...
    <div class="form-card">
        <form id="vehicle-type-form" method="POST" action="{{ route('admin.vehicle-types.store') }}"
            ...
            <div class="form-section">
                ...
                <div class="field">
                    ...
                    <input type="text" class="input @error('name') is-invalid @enderror" id="name" name="name"
                        value="{{ old('name') }}" placeholder="{{ __('es. Van') }}" required>
                    @error('name')
                ...
                <label class="switch-field">
                    <input type="checkbox" class="switch-input" id="needs_oxygen_check" name="needs_oxygen_check"
                        value="1" {{ old('needs_oxygen_check') ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                <button id="vehicle-type-submit-btn" type="submit" class="btn primary lg"
                    data-loading-text="{{ __('Salvataggio...') }}">
                    <i class="fa-solid fa-check"></i> {{ __('Salva tipo') }}
                </button>
