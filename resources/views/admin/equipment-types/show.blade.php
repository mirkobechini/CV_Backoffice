        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p><strong>Prima revisione (mesi):</strong> {{ $equipmentType->first_inspection_months }}</p>
                        <p><strong>Revisione regolare (mesi):</strong> {{ $equipmentType->regular_inspection_months }}</p>
                    </div>
                </div>
            </div>
        </div>
