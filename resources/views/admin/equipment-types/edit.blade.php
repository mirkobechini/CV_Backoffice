...
@section('breadcrumb')
    <x-admin.breadcrumb :items="[
        ...
        ['label' => $equipmentType->name, 'url' => route('admin.equipment-types.show', $equipmentType->id)],
        ['label' => __('Modifica')],
    ]" />
@endsection
...
@section('content')
    ...
    <div class="page-header">
        <h1>{{ __('Modifica tipologia di attrezzatura') }}</h1>
    ...
    <div class="form-card">
        <form id="equipmenttype-form" method="POST"
            action="{{ route('admin.equipment-types.update', $equipmentType->id) }}" enctype="multipart/form-data"
                ...
                <div class="row2">
                    <div class="field">
                        ...
                        <input type="text" class="input @error('name') is-invalid @enderror" id="name" name="name"
                            value="{{ old('name', $equipmentType->name) }}" required>
                        @error('name')
                    ...
                    <div class="field">
                        ...
                        <select class="select @error('category') is-invalid @enderror" id="category" name="category"
                            ...
                            @foreach (\App\Models\EquipmentType::CATEGORIES as $value)
                                <option value="{{ $value }}"
                                    {{ old('category', $equipmentType->category) == $value ? 'selected' : '' }}>
                ...
                <div class="row2">
                    <div class="field">
                        ...
                        <input type="number" class="input @error('first_inspection_months') is-invalid @enderror"
                            ...
                            value="{{ old('first_inspection_months', $equipmentType->first_inspection_months) }}"
                            min="0" placeholder="{{ __('es. 12') }}">
                    ...
                    <div class="field">
                        ...
                        <input type="number" class="input @error('regular_inspection_months') is-invalid @enderror"
                            ...
                            value="{{ old('regular_inspection_months', $equipmentType->regular_inspection_months) }}"
                            min="0" placeholder="{{ __('es. 12') }}">
                ...
                <div class="row2" id="extinguisher-type-fields" style="display:none;">
                    <div class="field">
                        ...
                        <input type="number" class="input @error('collaudo_interval_months') is-invalid @enderror"
                            ...
                            value="{{ old('collaudo_interval_months', $equipmentType->collaudo_interval_months) }}"
                            min="0" placeholder="{{ __('es. 60') }}">
                    ...
                    <div class="field">
                        ...
                        <input type="number" class="input @error('max_revisions_before_exchange') is-invalid @enderror"
                            ...
                            value="{{ old('max_revisions_before_exchange', $equipmentType->max_revisions_before_exchange) }}"
                            min="1" placeholder="{{ __('es. 8') }}">
            ...
            <div class="form-actions">
                <button id="equipmenttype-submit-btn" type="submit" class="btn primary lg"
                    ...
                    <i class="fa-solid fa-check"></i> {{ __('Salva modifica') }}
                </button>
