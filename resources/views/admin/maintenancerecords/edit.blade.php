                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('activity_type') is-invalid @enderror" id="activity_type"
                                ...
                                <option value="tagliando"
                                    {{ old('activity_type', $maintenanceRecord->activity_type) == 'tagliando' ? 'selected' : '' }}>
                                    Tagliando
                                </option>
                                <option value="revisione"
                                    {{ old('activity_type', $maintenanceRecord->activity_type) == 'revisione' ? 'selected' : '' }}>
                                    Revisione</option>
                                <option value="riparazione"
                                    {{ old('activity_type', $maintenanceRecord->activity_type) == 'riparazione' ? 'selected' : '' }}>
                                    Riparazione</option>
                                <option value="lavaggio"
                                    {{ old('activity_type', $maintenanceRecord->activity_type) == 'lavaggio' ? 'selected' : '' }}>
                                    Lavaggio</option>
                            </select>
                            @error('activity_type')
                                <div class="invalid-feedback">{{ $message }}</div>
