                ...
                <div class="row2">
                    ...
                    <div class="field">
                        ...
                        <input type="text" class="input @error('identification_number') is-invalid @enderror"
                            ...
                            value="{{ old('identification_number', $equipment->identification_number) }}">
                    ...
                    <div class="row2">
                        <div class="field">
                            ...
                            <select class="select @error('extinguisher_agent') is-invalid @enderror"
                                ...
                                <option value="co2"
                                    {{ old('extinguisher_agent', $equipment->extinguisher_agent) == 'co2' ? 'selected' : '' }}>
                                    {{ __('CO2') }}</option>
                                <option value="powder"
                                    {{ old('extinguisher_agent', $equipment->extinguisher_agent) == 'powder' ? 'selected' : '' }}>
                                    {{ __('Polvere') }}</option>
                            </select>
                        ...
                        <div class="field">
                            ...
                            <input type="number" step="0.01" class="input @error('weight_kg') is-invalid @enderror"
                                id="weight_kg" name="weight_kg" value="{{ old('weight_kg', $equipment->weight_kg) }}"
                                min="0">
                            @error('weight_kg')
                                <div class="field-error">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row2">
                        <div class="field" id="chair-type-field">
                            ...
                            <select class="select @error('chair_type') is-invalid @enderror" id="chair_type"
                                ...
                                <option value="electric"
                                    {{ old('chair_type', $equipment->chair_type) == 'electric' ? 'selected' : '' }}>
                                    {{ __('Elettrica') }}</option>
                                <option value="manual_2_wheel"
                                    {{ old('chair_type', $equipment->chair_type) == 'manual_2_wheel' ? 'selected' : '' }}>
                                    {{ __('Manuale a 2 ruote') }}</option>
                                <option value="manual_4_wheel"
                                    {{ old('chair_type', $equipment->chair_type) == 'manual_4_wheel' ? 'selected' : '' }}>
                                    {{ __('Manuale a 4 ruote') }}</option>
                                <option value="manual_tracks"
                                    {{ old('chair_type', $equipment->chair_type) == 'manual_tracks' ? 'selected' : '' }}>
                        ...
                        <div class="field">
                            ...
                            <input type="number" step="0.01" class="input @error('max_weight_kg') is-invalid @enderror"
                                id="max_weight_kg" name="max_weight_kg"
                                value="{{ old('max_weight_kg', $equipment->max_weight_kg) }}" min="0">
                            @error('max_weight_kg')
                                <div class="field-error">{{ $message }}</div>
                            @enderror
                        </div>
