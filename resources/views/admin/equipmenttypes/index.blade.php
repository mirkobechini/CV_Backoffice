@extends('layouts.app')
@section('content')
    <x-admin.index-table title="Tipi di attrezzature" tableClass="table table-striped table-hover my-0 align-middle text-center">
        ...
        <x-slot:rows>
            @foreach ($equipmentTypes as $equipmentType)
                <tr>
                    ...
                    <td>{{ $equipmentType->first_inspection_months ?? 'N/A' }}</td>
                    <td>{{ $equipmentType->regular_inspection_months ?? 'N/A' }}</td>
